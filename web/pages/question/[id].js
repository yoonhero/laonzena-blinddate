            ...
            <main className='w-screen h-screen bg-gray-100'>
                ...
                <div className='w-full relative flex flex-col items-center justify-center'>
                    ...
                    <div className='mt-10 text-center'>
                        <span className='text-black font-semibold text-4xl md:text-5xl break-all'>{question}</span>
                    </div>
                    ...
                    <div className='fixed h-20 w-screen bottom-0 flex flex-row items-center justify-around'>
                        <div>
                            <span className='font-bold text-2xl'>{`${questionIdx != undefined ? questionIdx + 1 : 0}/6`}</span>
                        </div>
                        <div>
                            <button
                                onClick={() => NextPage()}
